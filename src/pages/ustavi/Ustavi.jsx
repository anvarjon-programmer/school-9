        ...
        {/* <div className="my-20">
          <Slider {...settings}>
            <div className="wi-full">
              <h1 className="text-4xl text-center ">Ustavi</h1>
              <p className="mt-5">
                Mazkur namunaviy uctav O‘zbekiston Respublikasi Prezidentining
                2017 yil 15 fevral “O‘zbekiston Respublikasi Madaniyat vazirligi
                faoliyatini tashkil etish to‘g‘risida”gi PQ-2778-son va 2017 yil
                31 maydagi “Madaniyat va san’at sohasini yanada rivojlantirish
                va takomillashtirishga doir chora-tadbirlari to‘g‘risida”gi
                PQ-3022-son qarorlari, Vazirlar Mahkamacining 1995 yil 18
                fevraldagi 59-son qarori bilan tasdiqlangan “Maktabdan tashqari
                ta’lim muassasa to‘g‘risidagi nizom”, 1998 yil 5 yanvardagi
                5-son qarori bilan tasdiqlangan “Ta’lim muassasalapi ustavini
                ishlab chiqish tartibi” hamda 2017 yil 15 martdagi “O‘zbekiston
                Respublikasi Madaniyat vazirligi to‘g‘risidagi hamda O‘zbekiston
                Respublikasi Madaniyat vazirligi huzuridagi byudjetdan tashqari
                Madaniyat va san’atni rivojlantirish jamg‘armasi mablag‘larini
                shakllantirish va ulardan foydalanish tartibi to‘g‘risidagi
                nizomlarni tasdiqlash haqida”gi 141-son va 2016 yil 5 maydagi
                “Bolalar musiqa va san’at maktablari to‘g‘risidagi nizomni
                tasdiqlash haqida”gi 144-son qarorlari, O‘zbekiston Respublikasi
                Prezidentining 2022 yil 21 dekabrdagi “Yangi O‘zbekiston
                ma’muriy islohotlarini amalga oshirish chora-tadbirlari
                to‘g‘risida” PF-269-son Farmoni, Madaniyat vazirligining 2017
                yil 22 iyundagi “O‘zbekiston Respublikasi Madaniyat vazirligi
                tizimidagi bolalar musiqa va san’at maktablarining namunaviy
                ustavini tasdiqlash haqida”gi 361-sonli buyrug‘i, O’zbekiston
                Respublikasi Madaniyat vazirining 2023 yil 28 iyuldagi 1-sonli
                buyrug’i hamda Toshkent shahar Madaniyat boshqarmasi
                boshlig‘ining 2023 yil 26 sentyabrdagi 1-sonli buyrug‘iga
                muvofiq Uchtepa tumani 9-son bolalar musiqa va san’at maktabi
                faoliyatining asosiy qoidalarini belgilaydi.
              </p>
            </div>
            <div className="wi-full">
              <h1 className="text-4xl text-center ">1-bob. Umumiy qoidalar</h1>
              <p className="mt-5">
                1. Toshkent shahar, Uchtepa tumani 9-son bolalar musiqa va
                san’at maktabi (bundan buyon matnda 9-son BMSM deb yuritiladi)
                maktabdan tashqari ta’lim muassasasi hisoblanib, uning asosiy
                faoliyati unib-o‘sib kelayotgan yosh avlodning iste’dodini har
                tomonlama kamol toptirish va madaniy saviyasini yuksaltirish,
                o‘quvchilarning milliy va jahon musiqalari, tasviriy san’atining
                yuksak namunalaridan keng bahramand bo‘lishi uchun zarur
                sharoitlar yaratishga qaratilgan. 2. 9-son BMSM o‘z faoliyatida
                O‘zbekiston Respublikasi Konstitutsiyasi va qonunlariga,
                ...
                Mahkamasining qarorlariga va boshqa qonun hujjatlariga,
                shuningdek o‘z ustaviga amal qiladi. 3. 9-son BMSM davlat
                muassasasi shaklidagi yuridik shaxs hisoblanadi va o‘z ustaviga,
                mustaqil balansiga, shaxsiy g‘azna hisobvaraqlariga, O‘zbekiston
                Respublikasining Davlat gerbi tasviri tushirilgan va o‘z nomi
                yozilgan muhrga, shtampga va blankalarga ega bo‘ladi. 4. 9-son
                BMSMning Nizomi Namunaviy nizom asosida ishlab chiqilgan. Ta’lim
                muassasasining to‘liq nomi: O‘zbek tilida: TOSHKENT SHAHAR
                MADANIYAT BOSHQARMASI TASARRUFIDAGI UCHTEPA TUMANI 9-SON BOLALAR
                MUSIQA VA SAN’AT MAKTABI (qisqaptirilgan nomi: UCHTEPA TUMANI
                9-SON BOLALAR MUSIQA VA SAN’AT MAKTABI); ta’lim turiga
                tegishliligi - maktabdan tashqari ta’lim muassasasi; ta’lim
                faoliyati yo‘nalishi – musiqa va san’at; o‘qish shakli –
                kunduzgi (8:00-20:00); mulkchilik shakli – davlat ta’lim
                muassasasi; Toshkent shahar hokimligi 9-son bolalar musiqa va
                san’at maktabining muassisi hisoblanadi. ta’lim muassasasining
                identifikatsiya raqami (STIR): 300153008; ta’lim muassasasi 2006
                yil 09 sentyabrda 001209-1-son raqam bilan Toshkent shahar
                Yuridik shaxs (Tadbirkorlik sub’ektini) davlat ro‘yxatdan
                o‘tkazilgan; yuridik manzili: 100106, Toshkent sh., Uchtepa
                tumani, Ko’kcha Darvoza ko‘chasi – 627 uy. Bolalar musiqa va
                san’at maktabiga bevosita rahbarlikni Toshkent shahar Madaniyat
                boshqarmasi boshlig‘i tomonidan O‘zbekiston Respublikasi
                Madaniyat vazirligi bilan kelishgan holda lavozimga
                tayinlanadigan va lavozimdan ozod etiladigan direktor amalga
                oshiradi. 9-son BMSM Toshkent shahar xalq ta’limi bo’limining
                12.07.1967 yildagi 289-son Buyruqi asosida 1967 yilda tashkil
                topgan. 5. 9-son BMSMning umumiy faoliyati vazirlik tomonidan
                muvofiqlashtiriladi. Bolalar musiqa va san’at maktabi
                boshqapuvining yuqori organi Toshkent shahar Madaniyat
                boshqarmasi hisoblanadi.
              </p>
            </div>
            <div className="wi-full">
              <h1 className="text-4xl text-center ">
                2-bob. Muassasaning maqsad va vazifalari
              </h1>
              <p className="mt-5">
                6. 9-son BMSMning maqsadi yosh avlodning musiqa va san’at
                turlariga qiziqishi va qobiliyatini rivojlantirish, ijtimoiy
                faolligini oshirish, ularni xalqimiz an’analariga va milliy
                qadriyatlarimizga nisbatan hurmat ruhida tarbiyalash, ma’naviy
                va ma’rifiy saviyasini har tomonlama oshirishdan iborat. 7.
                9-son BMSMning vazifalari quyidagilardan iborat: o‘quvchilarning
                ma’naviy va estetik rivojlanishi uchun keng imkoniyatlar
                yaratish; o‘quvchilarning iste’dodini har tomonlama kamol
                toptirish, madaniy saviyasini yuksaltirish; o‘quvchilarni milliy
                va jahon musiqasi, tasviriy san’atning yuksak namunalaridan va
                o‘zbek xalqining mumtoz musiqa merosi durdonalaridan bahramand
                bo‘lishi uchun zarur sharoitlar yaratish; milliy hamda
                umuminsoniy qadriyatlarni uzviy birlashtirish asosida
                o‘quvchilarda yuksak axloqiy fazilatlarni shakllantirish;
                o‘quvchilarga umumiy musiqa, xoreografiya, teatr san’ati,
                tasviriy va amaliy san’at yo‘nalishlari bo‘yicha bilimlarning
                boshlang‘ich asoslarini o‘rgatish orqali ularni musiqa va san’at
                olamiga jalb etish; iqtidorli o‘quvchilarni musiqa va san’at
                yo‘nalishlari bo‘yicha o‘rta maxsus, kasb-hunar ta’limi
                muassasalarida o‘qishini davom ettirish uchun tayyorlash. 8.
                9-son BMSM o‘quvchilarning qiziqishlari va ehtiyojlariga ko‘ra,
                ularning ijodiy imkoniyatlarini yanada rivojlantirishga
                yo‘naltirilgan musiqa (fortepiano, torli cholg‘ular, estrada
                cholg‘u ijrochiligi, xalq cholg‘ulari, damli va zarbli
                cholg‘ular, an’anaviy cholg‘u ijrochiligi, an’anaviy xonandalik,
                akademik xonandalik, estrada xonandaligi) va san’at
                (xoreografiya, teatr san’ati, tasviriy va amaliy san’at)
                yo‘nalishlarida (keyingi o‘rinlarda ta’lim yo‘nalishlari deb
                ataladi) faoliyatini amalga oshiradi.
              </p>
            </div>
            <div className="wi-full">
              <h1 className="text-4xl text-center ">
                3-bob. Muassasaning huquqlari va majburiyatlari
              </h1>
              <p className="mt-5">
                9. 9-son BMSMda o‘quvchilarga ta’lim berish yakka tartibda yoki
                bir xil yoshdagi va turli yoshdagi bolalar guruhlarida ularning
                qiziqishlariga ko‘ra bir yoxud bir necha ta’lim yo‘nalishlari
                bo‘yicha amalga oshiriladi. 10. 9-son BMSMda o‘quv-tarbiyaviy
                ishlar O‘zbekiston Respublikasi Madaniyat vazirligi (bundan
                buyon matnda vazirlik deb yuritiladi) tomonidan tasdiqlanadigan
                o‘quv rejalari va o‘quv dasturlari asosida amalga oshiriladi.
                11. 9-son BMSMda o‘quv-tarbiya jarayonini tashkil qilish uchun
                bolalar musiqa va san’at maktabi direktorining buyrug‘i asosida
                ta’lim yo‘nalishlari bo‘yicha bo‘linmalar tashkil etilishi
                mumkin. 12. 9-son BMSMning huquqlari quyidagilardan iborat:
                bolalar musiqa va san’at maktabi xodimlari va o‘quvchilardan
                uning Nizomi va ichki mehnat tartibi qoidalariga rioya
                etilishini talab qilish; yangi pedagogik texnologiyalar asosida
                ta’lim va tarbiyaning qonun hujjatlariga zid bo‘lmagan shakli,
                vositalari va usullarini qo‘llash; bolalar musiqa va san’at
                maktabining moddiy-texnik bazasini mustahkamlash, ta’lim mazmuni
                va samaradorligini takomillashtirish bo‘yicha Madaniyat
                boshqaruv organlari va mahalliy davlat hokimiyati organlariga
                taklif kiritish; o‘z faoliyati samaradorligini oshirish
                maqsadida qonunchilikka muvofiq tarzda ko‘char va ko‘chmas
                mulklarni ijaraga olish; moliyalashtirishning qonun hujjatlarida
                taqiqlanmagan turli manbalari hisobiga byudjetdan tashqari
                mablag‘larni jalb qilish. 13. Quyidagilar 9-son BMSMning
                majburiyatlari hisoblanadi: Madaniyat boshqaruv organlarining
                hamda mahalliy davlat hokimiyati organlarining qarorlari,
                buyruqlari va boshqa me’yoriy hujjatlari ijrosini ta’minlash,
                topshiriq va ko‘rsatmalarini bajarish; ma’naviy yetuk, fidoyi,
                iqtidorli, tashabbuskor, sog‘lom va barkamol avlodni
                shakllantirish; o‘z ustavida belgilangan vazifalarni bajarish;
                yo‘nalishlar bo‘yicha tasdiqlangan o‘quv dasturlari asosida
                maktabning yillik o‘quv rejasini, dars va mashg‘ulotlar
                jadvalini ishlab chiqish; maktabdan tashqari ta’limga qo‘yilgan
                davlat talablari, belgilangan tartibda tasdiqlangan o‘quv rejasi
                va o‘quv dasturlari asosida ta’lim-tarbiya jarayonini tashkil
                etish; ta’lim-tarbiya jarayonini sanitariya qoidalari, normalari
                va gigiena normativlari, texnika va yong‘in xavfsizligi
                qoidalariga muvofiq tashkil etish; o‘quvchilarni maktabdan
                tashqari ta’limga jalb etish maqsadida targ‘ibot-tashviqot
                ishlarini olib borish; xodimlar va o‘quvchilar tomonidan o‘z
                vazifalarini bajarish uchun zarur shart-sharoitlar yaratilishini
                ta’minlash; bolalar musiqa va san’at maktabi xodimlarini qayta
                tayyorlashni va ularning malakasini oshirishni tashkil etish;
                bolalar musiqa va san’at maktabining moddiy-texnik bazasi
                saqlanishi va ulardan oqilona foydalanilishini ta’minlash;
                bolalar musiqa va san’at maktabining moddiy-texnika ta’minotini
                va kadrlar salohiyatini rivojlantirish; o‘quvchilarning
                ota-onalari yoki ularning o‘rnini bosuvchi shaxslar (bundan
                buyon ota-onalar deb yuritiladi) bilan shartnomalar tuzish;
                amaldagi qonun hujjatlariga muvofiq ichki mehnat tartibi
                qoidalarini o‘rnatish; yo‘nalishlar bo‘yicha o‘quvchilar,
                o‘qituvchilar va boshqa mutaxassislarning tuman (shahar),
                viloyat, recpublika va xalqaro ko‘rik-tanlovlari, festivallari,
                ustoz saboqlari hamda boshqa musiqa va san’at tadbirlarida
                ishtirok etishlarini ta’minlash. 14. Muassasa ishini tashkil
                etish va ish taptibi uning ichki mehnat tartibi qoidasida
                belgilanadi. 15. Muassasa zimmasiga qonun hujjatlarida nazarda
                tutilgan boshqa majburiyatlar ham yuklatilishi mumkin.
              </p>
            </div>
            <div className="wi-full">
              <h1 className="text-4xl text-center ">
                4-bob. Muassasada qabul jarayonini tashkil etish{" "}
              </h1>
              <p className="mt-5">
                16. 9-son BMSM rahbariyati har yili iyun - avgust oylarida
                o‘qishga qabul qilish ishlarini tashkil etadi. O‘quvchilar
                bolalar musiqa va san’at maktabiga vazirlik tomonidan
                belgilanadigan qabul kvotalari doirasida o‘qishga qabul
                qilinadi. Qabul kvotalari bolalar musiqa va san’at maktabining
                quvvati, moddiy-texnika bazasi, kadrlar bilan ta’minlanganlik
                darajasi, ta’lim yo‘nalishlari bo‘yicha talab va ehtiyojlarni
                inobatga olgan holda shakllantiriladi. 17. 9-son BMSMda qabul
                sinovlari o‘tkazish uchun direktorning buyrug‘i bilan besh
                kishidan iborat tarkibda qabul komissiyasi tuziladi. 18. Qabul
                komissiyasi tarkibiga muassasa direktori, mas’ul kotib,
                direktorning o‘quv-ma’rifiy ishlar bo‘yicha o‘rinbosari va
                tajribali pedagoglar kiritiladi. 19. Muassasaga o‘qishga kirish
                uchun o‘quvchining ota-onasi tomonidan 1 avgustdan 29
                avgustgacha qabul komissiyasiga quyidagi hujjatlar taqdim
                etiladi: a) o‘quvchilarni o‘qishga qabul qilish bo‘yicha ariza
                (ta’lim yo‘nalishi ko‘rsatilgan bo‘lishi kerak); b) o‘quvchining
                tug‘ilganlik haqidagi guvohnomasi nusxasi; v) tibbiy
                ma’lumotnoma; g) 3 x 4 o‘lchamli 2 ta fotosurat. 20. Qabul
                sinovlari har yili 31 avgustgacha o‘quvchining ijodiy
                qobiliyatini aniqlash maqsadida o‘tkaziladi. Qabul sinovlari
                qabul komissiyasi huzurida o‘tkaziladi. Qabul sinovlari bir
                marta topshiriladi, qayta topshirishga yo‘l qo‘yilmaydi. 21.
                Qabul komissiyasi o‘quvchining ota-onasini arizasida
                ko‘rsatilgan ta’lim yo‘nalishi bo‘yicha uning quyidagi ijodiy
                qobiliyatini qabul sinovlarida aniqlaydi: musiqa (fortepiano,
                torli cholg‘ular, estrada cholg‘u ijrochiligi, xalq cholg‘ulari,
                damli va zarbli cholg‘ular, an’anaviy cholg‘u ijrochiligi,
                an’anaviy xonandalik, akademik xonandalik, estrada xonandaligi)
                yo‘nalishi bo‘yicha musiqa ritmiga moslashishi, qo‘shiq aytishi,
                musiqani eshitishi va eslab qolishi; san’at yo‘nalishlari:
                xoreografiya bo‘yicha jismonan ma’qulligi (tana va oyoqlarning
                egiluvchanligi), ritmga moslashishi, musiqani eshitishi;
                tasviriy va amaliy san’at mutaxassisliklari bo‘yicha
                tasavvuridagi narsa-buyum yoki manzarani chiza olishi; teatr
                san’ati mutaxassisliklari bo‘yicha she’r yoki monologni yoddan
                ifodali o‘qishi va ovoz yoki harakatga nisbatan taqlid qila
                olishi. 22. O‘quvchining sinovdan o‘tgan yoki o‘tmaganligi qabul
                komissiyasi a’zolarining ochiq ovoz berishi yo‘li bilan
                aniqlanadi. Qabul komissiyasi a’zolarining ko‘pchiligi ijobiy
                ovoz bergan taqdirda o‘quvchi qabul sinovidan o‘tgan
                hisoblanadi. Qabul komissiyasining raisi barcha a’zolardan so‘ng
                ovoz beradi. Ovozlar soni teng bo‘lib qolganda qabul komissiyasi
                raisining ovozi hal qiluvchi hisoblanadi. 23. Qabul komissiyasi
                o‘quvchini o‘qishga qabul qilish yoki qabul qilmaslik
                to‘g‘risida qaror qabul qiladi. Qabul komissiyasining ijobiy
                qaroriga asosan muassasa direktori o‘quvchini o‘qishga qabul
                qilish to‘g‘risida buyruq chiqaradi. 24. O‘quvchilarni o‘quv
                yili davomida o‘qishga qabul qilishga yo‘l qo‘yilmaydi, boshqa
                bolalar musiqa va san’at maktabidan o‘qishi ko‘chirilgan
                o‘quvchilar bundan mustasno. 25. Muassasada o‘quvchilar
                kontingenti bir yilda bir marotaba - sentyabr oyida
                tasdiqlanadi. 26. 9-son BMSMning ikkinchi va undan yuqori
                sinflariga qabul qilish uchun o‘quvchilar mazkur Ustavning
                20-bandida nazarda tutilgan qabul sinovlaridan tashqari vazirlik
                tomonidan tasdiqlangan o‘quv dasturlari bo‘yicha tegishli
                sinfdagi bilim darajasiga qo‘yiladigan talablar asosida quyidagi
                maxsus fanlar bo‘yicha ham qabul sinovlarini topshiradilar: a)
                musiqa (fortepiano, torli cholg‘ular, estrada cholg‘u
                ijrochiligi, xalq cholg‘ulari, damli va zarbli cholg‘ular,
                an’anaviy cholg‘u ijrochiligi, an’anaviy xonandalik, akademik
                xonandalik, estrada xonandaligi) yo‘nalishi bo‘yicha -
                mutaxassislik va solfedjio fani; b) san’at yo‘nalishlari
                bo‘yicha: xoreografiya - mumtoz raqs, parter fani; tasviriy va
                amaliy san’at - chizma tasvir, rang tasvir, kompozitsiya fani;
                teatr san’ati - aktyorlik mahorati, sahna nutqi, sahna harakati
                fani. 27. O‘quvchining sinovdan o‘tgan yoki o‘tmaganligi qabul
                komissiyasi a’zolarining ochiq ovoz berishi yo‘li bilan
                aniqlanadi. Qabul komissiyasi a’zolarining ko‘pchiligi ijobiy
                ovoz bergan taqdirda o‘quvchi qabul sinovidan o‘tgan
                hisoblanadi. Qabul komissiyasining raisi barcha a’zolardan so‘ng
                ovoz beradi. Ovozlar soni teng bo‘lib qolganda qabul komissiyasi
                raisining ovozi hal qiluvchi hisoblanadi. 28. Qabul komissiyasi
                o‘quvchini o‘qishga qabul qilish yoki qabul qilmaslik
                to‘g‘risida qaror qabul qiladi. Qabul komissiyasining ijobiy
                qaroriga asosan bayonnoma rasmiylashtirilib, bolalar musiqa va
                san’at maktabi direktori o‘quvchini o‘qishga qabul qilish
                to‘g‘risida buyruq chiqaradi. O‘quvchilarni o‘quv yili davomida
                o‘qishga qabul qilishga yo‘l qo‘yilmaydi, boshqa bolalar musiqa
                va san’at maktabidan o‘qishi ko‘chirilgan o‘quvchilar bundan
                mustasno. 29. O‘quvchining ota-onasi o‘z xohishiga ko‘ra o‘quv
                yili davomida yoki u tugagandan so‘ng farzandini o‘qiyotgan
                bolalar musiqa va san’at maktabidan boshqasiga o‘tkazish
                huquqiga ega. O‘quvchilar ota-onalarining arizasi asosida
                o‘qiyotgan bolalar musiqa va san’at maktabidan boshqasiga ta’lim
                olayotgan ta’lim yo‘nalishi bo‘yicha o‘tkaziladi. 30. O‘qiyotgan
                bolalar musiqa va san’at maktabidan boshqasiga o‘tkazilgan
                o‘quvchilar tomonidan o‘qishni davom ettirish uchun tanlangan
                bolalar musiqa va san’at maktabiga mazkur Ustavning 17-bandida
                nazarda tutilgan arizadan tashqari quyidagi hujjatlar taqdim
                etiladi: o‘qigan joyidan ma’lumotnoma; o‘quvchining baholar
                (o‘zlashtirish) tabeli; yakka tartibdagi ish rejasi (musiqa
                yo‘nalishlari uchun). 31. O‘quvchini bir ta’lim yo‘nalishidan
                boshqa ta’lim yo‘nalishiga o‘tkazish bolalar musiqa va san’at
                maktabidagi ta’limning birinchi va ikkinchi yilida amalga
                oshiriladi. Yuqori sinflarda bir ta’lim yo‘nalishidan boshqa
                ta’lim yo‘nalishiga o‘tkazishga yo‘l qo‘yilmaydi. 32. Bir ta’lim
                yo‘nalishidan boshqasiga o‘tkazish bolalar musiqa va san’at
                maktabi direktorining buyrug‘iga asosan besh kishidan iborat
                tarkibda tuziladigan o‘quvchilarning o‘qishini bir ta’lim
                yo‘nalishidan boshqasiga ko‘chirish komissiyasining (bundan
                buyon matnda ko‘chirish komissiyasi deb yuritiladi) qaroriga
                asosan amalga oshiriladi. Ko‘chirish komissiyasi tarkibiga
                bolalar musiqa va san’at maktabi direktori, direktorning
                o‘quv-ma’rifiy ishlar bo‘yicha o‘rinbosari va pedagog xodimlar
                kiritiladi. Direktor ko‘chirish komissiyasi raisi hisoblanadi.
                Ko‘chirish komissiyasi o‘quv yili davomida faoliyat yuritadi.
                33. Ko‘chirish komissiyasi tomonidan bir ta’lim yo‘nalishidan
                boshqasiga o‘tkazishda o‘quvchining maktabdan tashqari ta’limga
                qo‘yiladigan mazkur yo‘nalish bo‘yicha davlat talablarining
                minimal darajasini bilishi hisobga olinadi. 34. Ko‘chirish
                komissiyasining qarori o‘quvchiga darhol e’lon qilinadi.
                Ko‘chirish komissiyasining qarori ijobiy bo‘lgan taqdirda, unga
                asosan direktor o‘quvchini tanlagan ta’lim yo‘nalishiga
                o‘tkazish to‘g‘risida buyruq chiqaradi. 35. 9-son BMSMda
                o‘quvchilar kontingenti bir yilda bir marta - sentyabr oyida
                tasdiqlanadi. 36. 9-son BMSM direktori bilan o‘qishga qabul
                qilingan o‘quvchilarning ota-onalari ortasida o‘qish muddatiga
                shartnoma tuziladi. 37. 9-son BMSM o‘quvchilarining huquqlari
                quyidagilardan iborat:
              </p>
            </div>
            <div className="wi-full">
              <h1 className="text-4xl text-center ">
                4-bob. O‘quv-tarbiyaviy va ilmiy uslubiy ish
              </h1>
